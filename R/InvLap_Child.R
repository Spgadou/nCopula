...
#'
#' With a specific path and a predefined structure (S4 class of a type 'Mother'),
#' this function returns the inverse LST expression of the corresponding node with
#' a specific variable.
#'
#' @description The function InvLap_Child() ...
