...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in rCop(10000, cop): no slot of name "{}theta"{} for this object of class "{}claytonCopula"{}}}\begin{alltt}
\hlstd{dens} \hlkwb{<-} \hlstd{cop}\hlopt{@}\hlkwc{dens}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): no slot of name "{}dens"{} for this object of class "{}claytonCopula"{}}}\begin{alltt}
\hlstd{logv} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{x}\hlstd{,} \hlkwc{data}\hlstd{)}
\hlstd{\{}
